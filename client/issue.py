...
if doIssue:
    ...
    for book in booksdata:
        if x == book['book_rfid'] and book['issued_by_name'] == 'Not Issued':
            tst = True
    ...
    if not tst:
        ...
        exit()
    if tst:
        ISSUEURL = 'https://smartlib.aimtechs.co.in/api/issueBook.php?auth=rHpW4fzd'
        #print(x)
        issuedata = {'rfid': x,
                     'rollno': rollno_imp,
        ...
        q = requests.post(url=ISSUEURL, json=issuedata)
        print(q.json())
