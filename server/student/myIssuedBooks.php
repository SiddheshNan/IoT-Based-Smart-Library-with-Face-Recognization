...
$title = "My Currently Issued Books";

$sql = "SELECT * FROM books WHERE issued_by_rollno = '{$_SESSION['rollno']}'";
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort" >Issued</th>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<th>{$row["book_name"]} </th>";
                                         ...
                                         echo '<th><span class="badge badge-pill badge-lg badge-success" style="font-size:90%;"> Currently Issued by You</span></th>';
                                         echo "<th>{$row["issued_at"]} </th>";
