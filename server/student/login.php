...
if(((isset($_SESSION['usertype'])) &&($_SESSION['usertype'] == 'user'))&&($_SESSION['login_user'])){
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id,rollno FROM users WHERE username = '$myusername' and password = '$mypassword'";
    ...
    if ($count == 1) {
        ...
        $_SESSION['rollno'] = strval($row['rollno']);
