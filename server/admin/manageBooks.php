                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort" >Book</th>
                                    <th scope="col" class="sort" >RFID</th>
                                    <th scope="col" class="sort" >Issue By Name</th>
                                    <th scope="col" class="sort" >Issue By RollNo</th>
                            ...
                            <tbody class="list">
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<th>{$row["book_rfid"]} </th>";
                                        echo "<th>{$row["issued_by_name"]} </th>";
                                        echo "<th>{$row["issued_by_rollno"]} </th>";
